            ...
            <form id="formCliente" name="formCliente" class="form-horizontal">
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  <label for="txtIdentificacion">Carnet de Identificacion <span class="required">*</span></label>
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  <label for="txtTelefono">Teléfono/Celular <span class="required">*</span></label>
