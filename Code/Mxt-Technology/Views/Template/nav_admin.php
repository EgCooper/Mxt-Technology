      ...
      <ul class="app-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="<?= base_url(); ?>/usuarios"><i class="fa fa-circle-thin"> </i>      Usuarios</a></li>
                <li><a class="treeview-item" href="<?= base_url(); ?>/roles"><i class="fa fa-circle-thin"> </i>     Roles</a></li>
            </ul>
        </li>
        <?php } ?>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="<?= base_url(); ?>/productos"><i class="fa fa-circle-thin"></i> Productos</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/categorias"><i class="fa fa-circle-thin"></i> Categorías</a></li>
                <?php } ?>
            </ul>
        </li>
        <?php } ?>
